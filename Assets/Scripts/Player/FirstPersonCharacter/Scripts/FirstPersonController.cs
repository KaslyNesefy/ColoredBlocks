...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : NetworkBehaviour
    {
        ...
        [SerializeField] private Camera[] m_elseCameras;
        ...
        public override void OnNetworkSpawn()
        {
            ...
            for (int i = 0; i < m_elseCameras.Length; i++) 
            { 
                m_elseCameras[i].gameObject.SetActive(false);
            }
            ...
            for (int i = 0; i < m_elseCameras.Length; i++) 
            { 
                m_elseCameras[i].gameObject.SetActive(true);
            }
